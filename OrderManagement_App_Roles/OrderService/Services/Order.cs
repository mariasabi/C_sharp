...
namespace OrderService.Services
{
    ...
    public async Task<Item> DeleteItem(int id)
    {
        ...
        public async Task<string> BulkAddItem(IFormFile file)
        {
            ...
            _dblog.CallStoredProcedure(DateTime.Now, Thread.CurrentThread.ManagedThreadId.ToString(), "INFO", nameof(Order), "Items added from " + file.Name + " and added to DB successfully" + emptyCell);
            log.Info("Items added from " + file.Name + " and added to DB successfully" + emptyCell);
